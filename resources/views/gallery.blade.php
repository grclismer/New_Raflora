        ...
        <div class="min-h-screen bg-cover bg-center" style="background-image: url('{{ asset('assets/images/background.jpg') }}');">
            ...
            <div class="relative z-10 max-w-6xl mx-auto px-6 md:px-12 py-20">
                ...
                <div class="text-center mt-16">
                    ...
                    <a href="{{ route('booking.start') }}" class="inline-block bg-white text-gray-900 font-semibold px-10 py-4 rounded shadow-lg uppercase hover:bg-gray-100 transition">Create Booking</a>
                </div>
            </div>
        </div>
    </main>
